...
function getValorSaque() {
  ...
  document.write(`Valor do saque foi de: ${valorSaque} growCoins <br>`);
...
function calculaNotas(saque) {

  var growCoins = [50, 10, 5, 1];
  let totalGc = 0;

  for( let gc of growCoins) {

    totalGc = parseInt(saque / gc);
    saque %= gc;

    if(totalGc !== 0){
      document.write(`${totalGc} growCoins de ${gc},00 <br>`);
    } 
